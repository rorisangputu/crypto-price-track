        ...
        <div className="w-full">
            <div className="w-[90%] mx-auto my-5">
                ...
                <form
                    ...
                    className="my-5 lg:w-[80%] mx-auto bg-white h-11 md:h-12 flex px-2 
                ...
                <div className="flex justify-between text-white text-medium mb-2 lg:w-[80%] mx-auto">
                ...
                <div className="shadow-xl rounded-lg mb-10 lg:w-[80%] mx-auto">
